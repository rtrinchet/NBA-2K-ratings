...
from get_data import get_teams_dict, get_soup, get_2018_data, get_2019_data, combine_df, get_stats, save_as_csv
import pandas as pd
# ## Ratings ---------- 2020!
...
ratings = combine_df(teams_dict, teams_dict, get_2018_data)

print(ratings.head(10).T)
# # # Creamos el fichero
